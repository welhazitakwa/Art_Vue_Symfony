 ...
 */
final class Version20240411202535 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livraison CHANGE commande commande INT DEFAULT NULL');
        $this->addSql('DROP INDEX fk_commande ON livraison');
        $this->addSql('CREATE INDEX IDX_A60C9F1F6EEAA67D ON livraison (commande)');
        $this->addSql('ALTER TABLE livraison ADD CONSTRAINT fk_commande FOREIGN KEY (commande) REFERENCES commande (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE oeuvre_concours (id INT AUTO_INCREMENT NOT NULL, id_oeuvre INT NOT NULL, id_concours INT NOT NULL, INDEX id_oeuvre (id_oeuvre), INDEX id_concours (id_concours), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE venteencheres (id INT AUTO_INCREMENT NOT NULL, id_exposition INT DEFAULT NULL, id_utilisateur INT NOT NULL, dateDebut DATE NOT NULL, dateFin DATE NOT NULL, prixDepart DOUBLE PRECISION NOT NULL, statue VARCHAR(200) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, INDEX id_utilisateur (id_utilisateur), INDEX fk_Exposition (id_exposition), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE vote (id INT AUTO_INCREMENT NOT NULL, concours INT NOT NULL, user INT NOT NULL, oeuvre INT DEFAULT NULL, note INT NOT NULL, INDEX fk_user (user), INDEX fk_oeuvres (oeuvre), INDEX fk_concours (concours), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE livraison CHANGE commande commande INT NOT NULL');
        $this->addSql('DROP INDEX idx_a60c9f1f6eeaa67d ON livraison');
        $this->addSql('CREATE INDEX fk_commande ON livraison (commande)');
