...
class CalendarController extends AbstractController
{
    ...
    #[Route('/calendar/{id}/events', name: 'app_calendar_events', methods: ['GET'])]
    public function displayCalendarEvents(Calendar $calendar): Response
    {
        $events = $calendar->getEvenements(); // Assuming you have a method to retrieve events associated with the calendar
